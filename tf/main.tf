...
EOT
  ...
  bootstrap_path = concat(var.bootstrap_path != null ? var.bootstrap_path : [], tolist(fileset(path.module, "${path.module}/../apps/infra/argo-cd/envs/${local.version_env}/configmap-**.yaml")))
}
