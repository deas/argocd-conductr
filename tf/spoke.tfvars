...
# by the hub cluster's Argo CD (envs/local-helm/appset-cluster-prod.yaml) and
...
env      = "spoke"
argo_env = "local-helm" # reuse the hub cluster class's cilium bootstrap values

argocd_install = null
bootstrap_olm  = false
bootstrap_path = []

cilium_appset_path = "../envs/local-helm/appset-infra-helm.yaml"
